...
const IndexSection1 = () => {
  ...
  return (
    <div className="flex flex-col md:py-[150px] py-20 px-2 items-center md:gap-[78px] gap-[30px] md:min-w-[720px] mx-auto">
      <h2 className="flex p-2 justify-center items-center gap-2 md:text-[50px] text-[28px] font-bold">
        {t("index.2.title")}
      </h2>
      <div className="flex md:flex-row flex-col text-[#2E2E2E] items-center md:gap-[72px] gap-[16px] flex-shrink-0">
        <div className="flex md:gap-[72px] gap-[20px] flex-shrink-0">
          {/* Step 1 Start */}
          <div className="flex flex-col items-center gap-[50px] flex-shrink-0">
            <StepIndicator num={1} />
            <div className="flex flex-col items-center gap-[26px]">
              <img src={step1} alt="Step1" />
              <div className="md:text-[20px] text-[16px]">{t("index.2.step1")}</div>
            </div>
          </div>
          {/* Step 1 End */}
          ...
          <div className="flex flex-col items-center gap-[39px] flex-shrink-0">
            ...
            <div className="flex flex-col items-center gap-[31px]">
              ...
              <div className="md:text-[20px] text-[16px]">{t("index.2.step2")}</div>
            </div>
          </div>
          {/* Step 2 End*/}
        </div>
        <div className="w-px h-[161px] bg-[#E5E5E5] flex-shrink-0 hidden md:block" />
        ...
        <div className="flex md:gap-[72px] gap-[20px] flex-shrink-0">
          ...
          <div className="flex flex-col items-center gap-[23px] flex-shrink-0">
            ...
            <div className="flex flex-col items-center gap-[16px]">
              ...
              <div className="md:text-[20px] text-[16px]">{t("index.2.step3")}</div>
            </div>
          </div>
          {/* Step 3 End*/}
          <div className="w-px h-[161px] bg-[#E5E5E5] flex-shrink-0" />
          ...
          <div className="flex flex-col items-center gap-[39px] flex-shrink-0">
            ...
            <div className="flex flex-col items-center gap-[34px]">
              ...
              <div className="md:text-[20px] text-[16px]">{t("index.2.step4")}</div>
            </div>
          </div>
          {/* Step 4 End*/}
        </div>
