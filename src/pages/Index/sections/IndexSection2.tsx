...
const IndexSection2 = () => {
  ...
  return (
    <div className="bg-[#F4F6FA] w-full">
      <div className="flex flex-col items-center md:gap-[90px] md:py-[160px] py-20 px-2 mx-auto w-cp md:w-full md:max-w-7xl">
        ...
        <div className="flex flex-col items-center md:gap-[100px] gap-[50px] mx-auto w-full">
          {/* Content 1 Start */}
          <div className="flex md:flex-row flex-col md:items-center w-fit md:w-full md:justify-between gap-12 md:gap-10">
            <TestReportImg />
            <ContentText num={1} />
          </div>
          {/* Content 1 End */}
...
const ContentText = ({ num }: { num: number }) => {
  const { t } = useTranslation();
  return (
    <div className="flex flex-col md:items-start self-start md:self-center gap-[10px] flex-shrink-0 w-fit md:w-[530px]">
