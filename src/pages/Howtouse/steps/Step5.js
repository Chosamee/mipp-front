      ...
      <StepImage
        contents={
          <div className="flex flex-col p-[10px] items-center">
            <h1 className="text-[16px] md:text-[22px] mb-6 self-start font-semibold">
              {t("result.my")}
            </h1>

            <div className="flex w-[280px] md:w-[424px] h-14 items-center md:gap-6 gap-4 justify-between border-b-[1px] border-[#E5E8EB]">
              <div className="py-1 gap-[10px] flex">
                ...
                {i18n.language === "en" ? (
                  <div className="text-xs md:text-[14px] text-center font-medium leading-[20px] text-[#171923]">
                    Latest
                  </div>
                ) : (
                  <div className="text-xs md:text-[14px] text-center font-medium leading-[20px] text-[#171923]">
              ...
              <div className="flex">
                {["all", "vocal", "melody", "boundary"].map((item, index) => {
                  return (
                    <button
                      className={`h-7 text-xs md:text-sm leading-5 font-semibold  md:px-3 px-2.5 py-1 items-center justify-center ${
                        inst === item
