...
const Criteria = () => {
  ...
  return (
    <div className="flex flex-col w-full gap-[44px] py-[50px] mx-auto bg-[#F9FAFB] rounded-[14px]">
      ...
      <div className="w-[280px] md:w-[740px] h-px bg-[#EAEFF4] self-center" />
...
export const ColorBar = () => {
  ...
  return (
    <React.Fragment>
      <div className="flex gap-10 md:gap-[70px] text-[#C9C9C9] text-[10px] font-medium items-center">
      ...
      <div className="flex mt-[7px] font-medium text-[13px] items-center text-center leading-[20px]">
        {colorSegments.map((segment) => (
          <div
            key={segment.label}
            className="w-[56px] md:w-[85px] px-[10px]"
