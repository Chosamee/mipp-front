    ...
    <div className="min-h-screen bg-gray-500  flex flex-col index-background">
      ...
      <div
        ...
        <div className="container mx-auto px-4 py-6 bg-white rounded-lg shadow mb-20">
          <div className="p-5">
            <h1 className="mx-auto text-6xl font-bold mb-20">
              음악 IP 보호 및 관리 솔루션
            </h1>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="">
                ...
                <p className="mb-10 text-xl">
                  MIPP만의 음원 분석 기술을 사용한 AI 음악 표절 검사를 무료로
                  해보세요 앨범 발매 전 표절로 인한 법적인 문제를 사전에 예방할
                  수 있습니다.
                </p>
                ...
                <p className="mb-10 text-xl">
                  전 세계에 새로 발매 되는 수억개의 노래 중에 내 노래를 표절한
                  노래가 있는지 찾아드립니다. MIPP 실시간 표절 모니터링 서비스로
                  귀하의 음악 저작권을 지키세요
                </p>
                <p className="mb-5 text-4xl font-bold">
                  03. 음악 IP 수익 극대화
                ...
                <p className="mb-10 text-xl">
                  MIPP을 통해 무단 표절 노래로 부터 저작권을 보호 하고 음악 IP의
                  수익을 극대화 시켜보세요
                </p>
              </div>
              <div className="z-20 ">
