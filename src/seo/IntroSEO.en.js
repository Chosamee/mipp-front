...
const IntroSEOEN = () => {
  return (
    <Helmet>
      ...
      <meta name="description" content="Setting the standard in plagiarism detection, MIPP is forward to protecting the rights of creators through the AI technology." />
